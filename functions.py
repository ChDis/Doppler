...
class Functions:
    ...
    def load_information(self):
        '''Function to load the information of the selected point in the interface'''
    ...
    def calculate_vectors(self, selected_point, source):
        ...
        final frecuency perceived, these 2 vectors are the  vector from the selected point to the source
        and the inverse of this vector'''
    ...
    def calculate_angle_between_vectors(self, vector1, vector2):
        '''Calculates the angle in radians between vector1 and vector2 
        with the point product and module of these vectors'''
        ...
        #we check if the module of the vectors is different from 0 to avoid division by 0 error
        ...
        #if one of the modules is 0, then the point is on top of the source, which in this case there will be no angle between the velocity vector and the vector that goes from the
        # selected point to the source,  or the velocity is 0, in which case there would also not be any angle,  and thus the sen must be 0
        return 1.5707


    def point_product(self, vector1, vector2):
        '''Function to find the point_product generated by adding each component of the vectors'''
        return (vector1[0]*vector2[0] + vector1[1]*vector2[1])


    def module_of_vector(self, vector):
        '''Function to calculate the module of the given vector'''
